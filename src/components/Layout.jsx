...
import { LayoutDashboard, Wheat, Heart, Wrench, AlertTriangle, BookOpen, FileText, LogOut } from 'lucide-react'
...
export default function Layout() {
  ...
  // Get display name — use Appwrite name field or email prefix
        ...
        <div className="modal-overlay" onClick={() => setShowLogout(false)}>
          <div className="modal-sheet" onClick={e => e.stopPropagation()}>
            ...
            <div style={{ textAlign: 'center', marginBottom: 20 }}>
              ...
              <div style={{ fontSize: 13, color: 'var(--slate-grey)', marginTop: 4 }}>
                {user?.email}
              </div>
            </div>
